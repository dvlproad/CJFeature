...
public struct BaseControlWidgetViewInApp: View {
...
//    @Binding var widgetStyle: ControlWidgetStyle  // 在app内的形态（控制中心不提供获取）
    ...
    public init(entity: BaseControlWidgetEntity, pageInfo: CCPageInfo) {
    ...
    // 接收 @Binding
    public init(bindingEntity: Binding<BaseControlWidgetEntity>, pageInfo: CCPageInfo) {
